...
const CtrlApplicationDetails = () => {
    ...
    const getApplication = async()=>{
        ...
        try {
            const res = await axios.post("/api/v1/controller/application",{appId}, {
              headers: {
    ...
    const onFinish = async(status)=>{
        try {
            const res=await axios.post('/api/v1/controller/changestatus',{appId,status})
            // setApp(res.data.data)
...
export default CtrlApplicationDetails